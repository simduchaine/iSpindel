...
const char HTTP_HEAD[] PROGMEM = "<!DOCTYPE html><html lang=\"en\"><head><meta name=\"viewport\" charset=\"utf-8\" content=\"width=device-width, initial-scale=1, user-scalable=no\"/><title>{v}</title>";
...
{"name":"Firebase",   "token":1,"server":1,"url":1,"port":0,"db":0,"username":0,"password":0,"job":0,"instance":0}];
